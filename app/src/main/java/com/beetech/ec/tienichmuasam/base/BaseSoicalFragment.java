...
public abstract class BaseSoicalFragment<T extends ViewDataBinding> extends BaseFragment<T> {
    private static final int RC_SIGN_IN = 9001;
    private static final String TAG = BaseSoicalFragment.class.getSimpleName();
